...
# Bucle para recorrer la lista newdivisa, en busca del elemento que contiene la "," para reemplazarlo por un "."
for i in range(len(newdivisa)):
     
     # Si el elemento es una ","
     if newdivisa[i]==",":
